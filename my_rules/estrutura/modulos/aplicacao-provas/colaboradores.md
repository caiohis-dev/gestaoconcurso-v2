...
`src/lib/cpf.ts` (`cpfValido`) implementa o módulo 11 — 11 dígitos, blacklist de repetidos, os dois DVs. É o **único** validador de CPF do repo, usado pelo `ColaboradorDialog` e pelo `CadastroLote`.
