...
- ~~**Deploy ainda no Lovable**~~ — 🔵 **sem objeto desde 2026-07-12.** A linha dizia que "o site continua sendo publicado pela plataforma"; o site do Lovable **deixou de existir**, e desde então não há deploy ativo em lugar nenhum. A hospedagem própria está desenhada em [`hospedagem-e-deploy.md`](../../hospedagem-e-deploy.md) e pendente de execução.
