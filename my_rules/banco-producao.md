...
7. **Publicar as edge functions:** `npx supabase functions deploy` (as 6 de `supabase/functions/`) e cadastrar os secrets `SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASS`. `db push` não publica function nenhuma.
