...
O desenho e as decisões (D1–D5) estão em [`../my_rules/analises/roadmap-modulos.yaml`](../my_rules/analises/roadmap-modulos.yaml); o mecanismo em [`../my_rules/estrutura/arquitetura-geral.md`](../my_rules/estrutura/arquitetura-geral.md) §6 e a matriz papel × módulo em [`../my_rules/estrutura/auth-e-permissoes.md`](../my_rules/estrutura/auth-e-permissoes.md).
