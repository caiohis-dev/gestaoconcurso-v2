...
Desenho em [`../my_rules/analises/concluidos/roadmap-editais.yaml`](../my_rules/analises/concluidos/roadmap-editais.yaml); modelo em [`../my_rules/estrutura/modulos/aplicacao-provas/provas-e-unidades.md`](../my_rules/estrutura/modulos/aplicacao-provas/provas-e-unidades.md).
...
- [ ] **A1** — Como **admin**, o hub (Início) mostra um **card Editais** (ao lado de Aplicação de Provas); "Entrar" abre `/editais`.
